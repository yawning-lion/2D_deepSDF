...
ap.add_argument('--num_shape_infer', type = int, default = 10)
...
ap.add_argument('--num_epochs', type = int, default = 1024)
ap.add_argument('--convariance', type = int, default = 0.1)
...
ap.add_argument('--batch_size', type = int, default = 1280)
